...
def extract_code_and_insights(response):
    ...
    if start_code in response and end_code in response:
        ...
        # Extract the insights section after "Insights:"
        insights_start = response.lower().find("insights:")
        insights = response[insights_start + len("insights:"):].strip() if insights_start != -1 else "No insights provided."

        return code, insights
    else:
        return None, "No valid code or insights found."
