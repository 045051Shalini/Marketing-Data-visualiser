...
if chart_type == "Bar Chart":
    response = agent.chat("Generate a bar chart for 'Final_Price(Rs.)' over 'Purchase_Date'. Ensure proper styling.")
elif chart_type == "Line Chart":
    response = agent.chat("Generate a line chart for 'Final_Price(Rs.)' over 'Purchase_Date'. Ensure proper styling.")
...
# Adjust agent prompt for insights
new_prompt_txt = """
You are designed to help with marketing data visualization in Plotly using Python.
You have access to tools providing dataset insights and styling instructions.
Please follow a structured approach, use JSON format for tool actions, and ensure correctness.
...
# Example query for insights
response = agent.chat("Generate a bar chart for 'Final_Price(Rs.)' over 'Purchase_Date' and provide insights on the trends observed.")
